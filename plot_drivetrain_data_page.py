...
def select_file(root):
    ...
    drivetrain_file_path = filedialog.askopenfilename(title="Open Drivetrain File", initialdir=file_manager.get_models_dir(), defaultextension=".pkl", filetypes=[("Pickle files", "*.pkl")])
