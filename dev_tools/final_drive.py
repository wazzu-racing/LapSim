...
class FinalDrive:
    def __init__(self):
        ...
        # self.analyze_gear_ranges(3.2)
        # self.analyze_gear_changes(3.1,5)
        # self.analyze_track(self.TRACK.ACCEL, iterations=50)
        self.analyze_ratios(2.96, 4)
    ...
    def analyze_gear_changes(self, ratio1, ratio2):
        ...
        self.racecar.drivetrain = drivetrain(ratio2, self.eng_data, limiter=1000)
        track_ex.run_accel(self.racecar, 1000)
