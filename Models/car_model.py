...
train = drivetrain_model.drivetrain(engine_data="/Users/jacobmckee/Documents/Wazzu Racing/LapSim/Data/csv/engine_array.csv")

with open("/Users/jacobmckee/Documents/Wazzu Racing/LapSim/Saved_Files/DEFAULT_DRIVETRAIN.pkl", 'wb') as f:
    pickle.dump(train, f)
